...
> open-project-manager-mcp — SQLite-backed project management MCP server
...
|------|------|---------|--------|
| Elliot | Lead & Architect | `.squad/agents/elliot/charter.md` | 🟢 Active |
| Darlene | Backend Dev | `.squad/agents/darlene/charter.md` | 🟢 Active |
